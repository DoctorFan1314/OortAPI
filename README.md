...
- **Multi-page documentation** — 17 docs pages: Features Overview, Models & Pricing, FAQ, enriched Endpoints/Errors/SDK/Streaming/Rate Limits with request schemas & troubleshooting, 4-group sidebar, feedback widget, code block syntax highlighting with hover copy
...
- **Token breakdown** — Dashboard shows detailed 3-way token split: Input(non-cached), Input(cache hit), Output
