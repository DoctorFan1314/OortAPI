...
- **API 测试场** — 交互式测试：选择模型 + Key，多轮对话，可配置参数，流式响应，MCP 工具循环，工具管理器
- **资源中心** — AI 应用市场：17 个云端 MCP 节点、28+ Prompt 模板、客户端技能，一键激活至测试场
- **多页文档** — 侧边栏导航文档：快速开始、认证、API 端点、SDK 集成、流式响应、定价、错误码、速率限制、部署、集成指南、Swagger UI
...
- **API 测试场** — 交互式 API 测试 `/dashboard/playground`，模型选择、流式响应、Markdown 渲染、对话导出、MCP 工具循环（Tool Loop）、工具管理器面板
