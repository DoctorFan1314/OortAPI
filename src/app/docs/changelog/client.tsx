...
export function ChangelogContent() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      {/* Cross Links */}
      <CrossLinks links={[
        { title: locale === "zh" ? "功能总览" : "Features", href: "/docs/features", description: locale === "zh" ? "OortAPI 核心能力一览" : "A quick look at OortAPI capabilities" },
        { title: locale === "zh" ? "模型与定价" : "Models & Pricing", href: "/docs/models-pricing", description: locale === "zh" ? "热门模型价格与计费方式" : "Popular model prices and billing" },
      ]} />
    </div>
  );
}
