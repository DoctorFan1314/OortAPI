export interface Dictionary {
  ...
  dashboard: {
    ...
    unsaved: string;
    notifPrefs: string;
    notifBudgetExceeded: string;
    notifBudgetExceededDesc: string;
    notifKeyExpiring: string;
    notifKeyExpiringDesc: string;
    notifPlanExpiring: string;
    notifPlanExpiringDesc: string;
    notifUsageSpike: string;
    notifUsageSpikeDesc: string;
    notifPrefsSaved: string;
    notifPrefsSaveFailed: string;
    ...
    changeExchangeRateDesc: string;
    exchangeRateLabel: string;
    // Log-table additions
    creditsBreakdown: string;
    creditRate: string;
    totalCreditsUsed: string;
    subscriptionNoCharge: string;
    modelRates: string;
    subtotalBaseCost: string;
    ...
    addBtn: string;
    cancelSub: string;
    noSubscriptionMsg: string;
    giftBtn: string;
    cancelSubscriptionTitle: string;
    cancelSubMsg: string;
    confirmCancel: string;
    subscriptionCancelled: string;
    subCancelledRefund: string;
    ...
    // Channels additions
    routedModels: string;
    failedHealthData: string;
    urlMustStart: string;
    createFailed: string;
    channelCreated: string;
    deletedCh: string;
    commaSeparatedEmptyAll: string;
    ...
    support: string;
    models: string;
    deletePlanItem: string;
    enterPlanDetails: string;
    planName: string;
    displayName: string;
    tagline: string;
